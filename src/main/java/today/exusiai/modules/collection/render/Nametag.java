...
import today.exusiai.utils.GLUtil;
...
public class Nametag extends AbstractModule {
	...
	public Nametag() {
		super("NameTag", 0, AbstractModule.Category.Visuals);
	}
	...
	public void renderNameTag(EntityPlayer entity, String tag, double pX, double pY, double pZ) {
		...
		if(entity.getHeldItem() != null) {
			...
			this.renderItemStack((ItemStack)object, k, -25);
			k = k + 20;
		}
		...
		for(ItemStack itemstack1 : entity.inventory.armorInventory) {
			if(itemstack1 != null) {
				...
				this.renderItemStack(itemstack2, k, -25);
				k += 20;
			}
		}
