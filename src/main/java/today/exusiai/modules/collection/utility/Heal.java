...
public class Heal extends AbstractModule {
   ...
   public Heal() {
      super("Heal", 0, AbstractModule.Category.Utility);
   ...
   public void Tick(ClientTickEvent event) throws Exception {
      ...
      } else if (this.stage == 3 && this.timerUtil.hasReached(this.Delay.getValue())) {
         this.count();
         this.timerUtil.reset();
      }
